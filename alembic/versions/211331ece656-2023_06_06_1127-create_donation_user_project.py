"""Create Donation, User, Project

Revision ID: 211331ece656
Revises: 
Create Date: 2023-06-06 11:27:48.815170
...
def upgrade():
    """Команды при выполнении миграций"""
    op.create_table(
        'charityproject',
